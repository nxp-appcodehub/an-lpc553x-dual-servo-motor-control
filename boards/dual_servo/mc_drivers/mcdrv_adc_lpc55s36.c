...
void MCDRV_CurrAndVoltDcBusGet(mcdrv_adc_t *this)
{
    ...
    {       
    	switch( this->s_ADC_ResultStructure.commandIdSource )
    	{
    		...
    		case 2U:
    			...
    			*this->pf16UDcBus    = (frac16_t)(this->ui16AdcDCBVolt >> 1);
    			break;
    ...
    switch (*this->pui16SVMSector)
    {
        ...
        case 3:
            ...
            sIABCtemp.f16A = (((this->ui16AdcSmpChannelA)) - this->sCurrSec23.ui16OffsetPhaA);
            sIABCtemp.f16C = (((this->ui16AdcSmpChannelB)) - this->sCurrSec23.ui16OffsetPhaC);
        ...
        case 5:
            ...
            sIABCtemp.f16A = (((this->ui16AdcSmpChannelA)) - this->sCurrSec45.ui16OffsetPhaA);
            sIABCtemp.f16B = (((this->ui16AdcSmpChannelB)) - this->sCurrSec45.ui16OffsetPhaB);
        ...
        default:
            ...
            sIABCtemp.f16B = (((this->ui16AdcSmpChannelA)) - this->sCurrSec16.ui16OffsetPhaB);
            sIABCtemp.f16C = (((this->ui16AdcSmpChannelB)) - this->sCurrSec16.ui16OffsetPhaC);
    ...
    switch (*this->pui16SVMSector)
    {
        ...
        case 3:
            ...
            this->sCurrSec23.ui16CalibPhaA =
                GDFLIB_FilterMA_F16((this->ui16AdcSmpChannelA), &this->sCurrSec23.ui16FiltPhaA);
            this->sCurrSec23.ui16CalibPhaC =
                GDFLIB_FilterMA_F16((this->ui16AdcSmpChannelB), &this->sCurrSec23.ui16FiltPhaC);
            break;
        ...
        case 5:
            ...
            this->sCurrSec45.ui16CalibPhaA =
                GDFLIB_FilterMA_F16((this->ui16AdcSmpChannelA), &this->sCurrSec45.ui16FiltPhaA);
            this->sCurrSec45.ui16CalibPhaB =
                GDFLIB_FilterMA_F16((this->ui16AdcSmpChannelB), &this->sCurrSec45.ui16FiltPhaB);
        ...
        default:
            ...
            this->sCurrSec16.ui16CalibPhaB =
                GDFLIB_FilterMA_F16((this->ui16AdcSmpChannelA), &this->sCurrSec16.ui16FiltPhaB);
            this->sCurrSec16.ui16CalibPhaC =
                GDFLIB_FilterMA_F16((this->ui16AdcSmpChannelB), &this->sCurrSec16.ui16FiltPhaC);
