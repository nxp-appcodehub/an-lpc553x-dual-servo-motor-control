...
void BOARD_BootClockFROHF96M(void)
{
    ...
    CLOCK_SetClkDiv(kCLOCK_DivAdc0Clk, 2U, true);             /*!< Set ADC0CLKDIV0 divider to value 2 */
    CLOCK_SetClkDiv(kCLOCK_DivAdc1Clk, 2U, true);               /*!< Set ADC1CLKDIV0 divider to value 2 */
