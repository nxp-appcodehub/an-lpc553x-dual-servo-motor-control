 ...
 */
/**********************************************************************/
// File Name: {FM_project_loc}/../../../boards/frdmkv31f/demo_apps/mc_pmsm/pmsm_snsless/M2_pmsm_appconfig.h 
//
...
#define M2_N_MAX                           (922.0F)
#define M2_FREQ_MAX                        (147.0F)
#define M2_U_DCB_TRIP                      (32.0F)
#define M2_U_DCB_UNDERVOLTAGE              (16.0F)
#define M2_U_DCB_OVERVOLTAGE               (29.0F)
#define M2_N_OVERSPEED                     (921.3F)
#define M2_N_MIN                           (62.8F)
#define M2_N_NOM                           (837.8F)
...
#define M2_D_KP_GAIN                       (0.908503238985F)
#define M2_D_KI_GAIN                       (0.131962264152F)
//Q-axis Controller - Parallel type     
#define M2_Q_KP_GAIN                       (1.302986745311F)
#define M2_Q_KI_GAIN                       (0.167654290933F)
...
#define M2_SPEED_PI_PROP_GAIN              (0.002210218185F)
#define M2_SPEED_PI_INTEG_GAIN             (0.000019442095F)
#define M2_SPEED_LOOP_HIGH_LIMIT           (2.0F)
#define M2_SPEED_LOOP_LOW_LIMIT            (-2.0F)

#define M2_SPEED_RAMP_UP                   (2.094395102393F)
#define M2_SPEED_RAMP_DOWN                 (2.094395102393F)
...
//----------------------------------------------------------------------
//Bemf DQ Observer                      
#define M2_I_SCALE                         (0.879912663756F)
#define M2_U_SCALE                         (0.218340611354F)
#define M2_E_SCALE                         (0.218340611354F)
#define M2_WI_SCALE                        (0.000111790394F)
#define M2_BEMF_DQ_KP_GAIN                 (0.969274207277F)
#define M2_BEMF_DQ_KI_GAIN                 (0.143188220652F)
...
//Open loop start-up                    
#define M2_OL_START_RAMP_INC               (0.062831853072F)
#define M2_OL_START_I                      (0.65F)
#define M2_MERG_SPEED_TRH                  (104.71975511966F)
#define M2_MERG_COEFF                      FRAC16(0.009155273438)

//Control Structure Module - Scalar Control
//----------------------------------------------------------------------
#define M2_SCALAR_VHZ_FACTOR_GAIN          (0.11249999999999999F)
#define M2_SCALAR_INTEG_GAIN               ACC32(0.029333333333)
#define M2_SCALAR_RAMP_UP                  (0.033333333333F)
#define M2_SCALAR_RAMP_DOWN                (0.033333333333F)
